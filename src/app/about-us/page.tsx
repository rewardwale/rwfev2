...
export default function AboutUs(props: HeroType) {
  const settings = {
    dots: true,
    infinite: true,
    speed: 600,
  ...
  const RewardWaleTitleCard = () => {
    return (
      <div className="relative">
        <div
          className="max-w-3xl mx-auto text-center md:pb-16 
          flex flex-col justify-center"
        >
          <h1
            className="mb-4 mt-4 lg:mt-0 
             md:text-violet-600 text-neutral-700 dark:text-stone-300 
             md:text-4xl 2xl:text-[50px] font-bold md:font-semibold"
          >
            Why <span className="text-violet-600">Rewardwale</span> ?
          </h1>
          <p className="text-xs md:text-lg 2xl:text-xl font-normal mb-10 text-center text-neutral-700 dark:text-stone-300">
  ...
  const InfoCard = (props: InfoCardType) => {
    return (
      <div className="">
        <div className="relative ">
          <div
            className="md:w-96 md:h-60 2xl:h-80 2xl:w-[30rem]  bg-white
                 dark:bg-neutral-800 shadow rounded-3xl 
                 py-6 md:py-14 px-8 md:px-10"
          >
            <div className="flex-col justify-items-start gap-2 md:gap-5 flex">
              <h1
                className="text-blue-950
                     dark:text-stone-50 text-sm md:text-lg 2xl:text-2xl font-bold"
              >
                {props.title}
              </h1>
              <p
                className="text-zinc-700 dark:text-neutral-400 
                    text-xs md:text-base 2xl:text-xl font-normal 2xl:tracking-normal 
                    2xl:mt-4"
              >
                {props.description}
              </p>
  ...
  const ReviewMatterCard = () => {
    return (
      <div className="py-4 md:my-16 ">
        <h1
          className="h1 mb-6 md:text-violet-600 text-neutral-700
         dark:text-stone-300 md:text-4xl 2xl:text-4xl text-center 
        ...
        <div className="flex items-center justify-between gap-3 px-2  md:px-8 lg:px-20">
          <div
            className="flex flex-col gap-3  md:gap-5 md:w-96 text-xs 2xl:w-full
          md:text-base 2xl:text-xl text-neutral-700 dark:text-stone-300"
          >
            <p>
  ...
  return (
    <div className="bg-white dark:bg-zinc-900  overflow-hidden">
      ...
      <Slider {...settings} className="">
        {[
          ...
          <section className="relative" key={index}>
            ...
            <div
              className=" mx-auto px-4 sm:px-6 absolute left-0 right-0 -bottom-36
             sm:-bottom-8  
              md:-bottom-10
              lg:bottom-16
              xl:bottom-20
            ...
            >
              <div
                className=" z-40 mt-10 bg-gradient-to-r 
                p-8
                 from-[#C84AD6] to-[#6F3CE3CC]
               rounded-lg"
              >
                <div className=" text-center justify-center items-center flex flex-col gap-4 max-md:gap-2 ">
                  <h1 className=" text-white text-sm sm:text-2xl md:text-3xl xl:text-5xl lg:text-2xl 2xl:text-7xl font-semibold font-['Nunito']">
                    {item.title}
                  </h1>
                  <p className="text-white text-xs sm:text-sm md:text-lg xl:text-xl lg:text-xl 2xl:text-4xl font-medium text-center">
                    {item.desc}
                  </p>
                </div>
              </div>
      ...
      <div className="relative">
        <div
          className="absolute  
        lg:-top-24 2xl:-top-44 
        left-0 right-0 w-full"
        >
          <Image
            src={props.getTheme === "light" ? BlockImage1 : BlockImage2}
            alt="vectors"
        ...
        <section className="relative  ">
         ...
         mx-auto sm:px-6 px-4 h-full  "
          >
            ...
            gap-4 px-4 md:px-28 py-4 md:py-10 
           bg-purple-300 rounded-xl max-md:my-6 lg:m-12 "
              >
                ...
                <div
                  className="flex flex-col gap-5 text-xs md:text-base 2xl:text-2xl 
             tracking-wide 2xl:tracking-tight 2xl:w-2/3"
                >
                  <p>
            ...
            <div className="flex justify-center items-center">
              <div
                className="bg-white dark:bg-zinc-800 rounded-xl  shadow-lg
 shadow-violet-200 dark:shadow-black my-12 lg:mx-12 p-7  md:block"
              >
                ...
                <div className="flex items-center justify-between mx-10">
                  <div
                    className="flex flex-col gap-5 text-xs md:text-base 
              2xl:text-xl  2xl:w-2/3 tracking-wide text-neutral-700
               dark:text-stone-300"
                  >
                    <p>
            ...
            <div
              className="grid md:grid-cols-2 gap-5 md:my-12 lg:mx-12 
          2xl:mx-0 md:py-7 lg:px-7 max-md:pb-3"
            >
              <div
